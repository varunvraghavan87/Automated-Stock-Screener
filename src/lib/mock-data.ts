...
export const MOCK_STOCKS: Array<{
  ...
  // STRONG BUY candidates - perfect pullback setups with all indicators bullish
  {
    ...
    indicators: {
      ...
      atr14: 3.8, relativeStrength3M: 4.2, volumeSMA20: 32000000, weekChange: -2.1,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 22.5, relativeStrength3M: 6.8, volumeSMA20: 14200000, weekChange: -1.5,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 38.5, relativeStrength3M: 3.5, volumeSMA20: 9500000, weekChange: -2.8,
  ...
  // BUY candidates - good but not perfect
  {
    ...
    indicators: {
      ...
      atr14: 18.2, relativeStrength3M: 2.1, volumeSMA20: 11200000, weekChange: -1.2,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 110.0, relativeStrength3M: 5.8, volumeSMA20: 3800000, weekChange: -3.2,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 42.0, relativeStrength3M: 1.9, volumeSMA20: 4800000, weekChange: -1.8,
  ...
  // WATCH candidates - trend established but no pullback yet
  {
    ...
    indicators: {
      ...
      atr14: 15.0, relativeStrength3M: 7.2, volumeSMA20: 14500000, weekChange: 2.5,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 20.0, relativeStrength3M: 8.5, volumeSMA20: 6200000, weekChange: 3.1,
  ...
  // NEUTRAL - passes Phase 1 but fails Phase 2
  {
    ...
    indicators: {
      ...
      atr14: 8.5, relativeStrength3M: -2.1, volumeSMA20: 25000000, weekChange: -3.5,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 6.2, relativeStrength3M: -1.5, volumeSMA20: 9800000, weekChange: -2.8,
  ...
  // More BUY/STRONG BUY candidates
  {
    ...
    indicators: {
      ...
      atr14: 52.0, relativeStrength3M: 4.8, volumeSMA20: 4200000, weekChange: -2.5,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 24.0, relativeStrength3M: 6.2, volumeSMA20: 5100000, weekChange: -3.1,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 185.0, relativeStrength3M: 3.8, volumeSMA20: 1500000, weekChange: -2.2,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 48.0, relativeStrength3M: 5.5, volumeSMA20: 3200000, weekChange: -1.9,
  ...
  },
  {
    ...
    indicators: {
      ...
      atr14: 28.0, relativeStrength3M: 2.8, volumeSMA20: 4200000, weekChange: -1.1,
  ...
  // AVOID candidates - fails Phase 1
  {
    ...
    indicators: {
      ...
      atr14: 4.5, relativeStrength3M: -12.5, volumeSMA20: 520000, weekChange: -8.2,
